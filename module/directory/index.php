...
switch ($sysVar[mode]){
	...
	case "v_addCategory":
		...
		break;
	case "c_addCategory":
		system::debug($settings['debugFile'], "chrM", "	Module-Function=> directory Module >> index.php-> c_addCategory\n");
	...
	case "v_editCategory":
		...
		break;
	case "c_editCategory":
		system::debug($settings['debugFile'], "chrM", "	Module-Function=> directory Module >> index.php-> c_editCategory\n");
	...
	case "v_delCategory":
		...
		break;
	case "c_delCategory":
		system::debug($settings['debugFile'], "chrM", "	Module-Function=> directory Module >> index.php-> c_delCategory\n");
		$c_directory->c_delCategory($_POST[id]);
		break;
		// List Category
	case "c_listCategory":
		system::debug($settings['debugFile'], "chrM", "	Module-Function=> directory Module >> index.php-> c_listCategory\n");
...
//		$system->xorg->smarty->display("$settings[moduleAddress]/$settings[moduleName]/$settings[viewAddress]/$settings[tplAddress]/object" . $settings['ext4']);
	...
	case "c_showListObject":
		system::debug($settings['debugFile'], "chrM", "	Module-Function=> directory Module >> index.php-> c_showListObject\n");
		...
		break;
	case "c_rssFeed":
		system::debug($settings['debugFile'], "chrM", "	Module-Function=> directory Module >> index.php-> c_rssFeed\n");
