 ...
 * Rev:  1.3.2
 */
	$.fn.mcDropdown = function(list, options, className) {
...
//$('#cmpItem3').html('ttt  '+className);		
		...
		function showBranch(){
			...
			// move the menu to the correct position and show the menu || ((depth)*2) //// show submenu
			$ul.css({top: li_coords.bottom, left: li_coords.marginLeft+110/*, zIndex: settings.baseZIndex + ((depth)*2)*/}).show();

/** 
$('#cmpItem2').html('li_coords.marginLeft-> ' + li_coords.marginLeft + ' ,li_coords.top-> ' + li_coords.top + ' ,li_coords.bottom->' + li_coords.bottom + ' ,li_coords.left->' + li_coords.left + ' ,li_coords.right->' + li_coords.right);
 **/
