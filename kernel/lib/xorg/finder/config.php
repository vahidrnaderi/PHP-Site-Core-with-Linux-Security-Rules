...
if(empty($_SESSION[uid]) || $_SESSION[uid] == 2){
	die("Access Deny, Please login to system.");
}
/*
...
//$baseUrl = "http://" . $_SERVER['HTTP_HOST'] . "/home/" . $_SESSION['uid'] . '/';
$baseUrl = "home/" . $_SESSION['uid'] . '/';
...
/*
 ...
 ATTENTION: The trailing slash is required.
 */
$baseDir = $_SERVER['DOCUMENT_ROOT'] . "/home/" . $_SESSION['uid'] . '/';
/*
 * ### Advanced Settings
 */
...
$config['ResourceType'][] = Array(
		...
		'maxSize' =>  "300K",	//"10M",
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,webm,ogg,oga',
		'deniedExtensions' => '');
